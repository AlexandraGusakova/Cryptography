...
namespace Lab10
{
    ...
    public static class Rsa
    {
        public static void CheckCorrectly()
        {
            var p = 7;
            var q = 13;
            var pathToSource = "E:\\Study\\3-2\\Криптографические основы защиты информации\\Лабы\\Crypto_9_13\\Test.txt";
            var pathToEds = "E:\\Study\\3-2\\Криптографические основы защиты информации\\Лабы\\Crypto_9_13\\RSA.txt";
        ...
        public static void CheckInCorrectly()
        {
            ...
            var q = 13;
            var pathToSource = "E:\\Study\\3-2\\Криптографические основы защиты информации\\Лабы\\Crypto_9_13\\Test.txt";
            var pathToFakeSource = "E:\\Study\\3-2\\Криптографические основы защиты информации\\Лабы\\Crypto_9_13\\FakeTest.txt";
            var pathToEds = "E:\\Study\\3-2\\Криптографические основы защиты информации\\Лабы\\Crypto_9_13\\RSA.txt";
            var result = Create(p, q, pathToSource, pathToEds);
    ...
    // https://www.intuit.ru/studies/courses/553/409/lecture/9379?page=5
